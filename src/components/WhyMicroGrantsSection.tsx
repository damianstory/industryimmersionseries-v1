      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <div className="lg:col-start-1 flex justify-start">
            <div className="w-full max-w-[315px] bg-gray-100 rounded-xl overflow-hidden flex items-center justify-center aspect-[9/16]">
              <div className="text-center p-6 sm:p-8">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-[#8367f6] rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <div className="lg:col-span-2">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Why <span className="text-[#8367f6]">Micro Grants?</span></h2>
            ...
            <div className="bg-purple-50 p-6 rounded-xl mb-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <div className="text-[#8367f6] mr-3 text-xl font-bold">•</div>
                  <div>
            ...
            <div className="italic text-gray-600 border-l-4 border-[#8367f6] pl-4 mb-8">
            ...
            <button className="px-6 py-3 bg-[#8367f6] text-white font-medium rounded-lg hover:bg-[#7559e0] transition-colors">
