        ...
        <div className="flex flex-col gap-10">
          <div className="text-center mb-6">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              How It <span className="text-[#8367f6]">Works</span>
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-md h-full lg:col-span-2 p-6 aspect-square lg:aspect-auto flex justify-between flex-col">
              <FileText className="w-8 h-8 stroke-1 text-[#8367f6]" />
            ...
            <div className="bg-white rounded-xl shadow-md aspect-square p-6 flex justify-between flex-col">
              <Users className="w-8 h-8 stroke-1 text-[#8367f6]" />
              <div className="flex flex-col">
            ...
            <div className="bg-white rounded-xl shadow-md aspect-square p-6 flex justify-between flex-col">
              <Upload className="w-8 h-8 stroke-1 text-[#8367f6]" />
              <div className="flex flex-col">
            ...
            <div className="bg-white rounded-xl shadow-md h-full lg:col-span-2 p-6 aspect-square lg:aspect-auto flex justify-between flex-col">
              <Award className="w-8 h-8 stroke-1 text-[#8367f6]" />
              <div className="flex flex-col">
